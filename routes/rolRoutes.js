...
router.get('/', authMiddleware(["admin", "empleado"]), getRoles);
router.get('/:id', authMiddleware(["admin", "empleado"]), authMiddleware(), getRolById);
router.post('/',authMiddleware(["admin", "empleado"]), rolValidate, validate, postRol);
